...
public class UserService implements UserDetailsService {
    ...
    public Long getNewUsersThisWeek() {
        ...
        return userRepository.countNewUsersThisWeek(startOfWeek);
    }

    // Phương thức lấy số người dùng mới mỗi ngày trong tuần
    public List<Long> getNewUsersPerDayInWeek() {
        LocalDate startOfWeek = getStartOfCurrentWeek();
        return userRepository.countNewUsersForWeek(startOfWeek);
    }
